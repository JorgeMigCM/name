...
<html lang="en">
    ...
    <link rel="stylesheet" href="assets/css/redes-sociales.css">
    ...
    <meta name="theme-color" content="#1d82ff">
    <meta name="background_color" content="#1d82ff">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="probootstrap-navbar">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="#section-attorneys">Integrantes</a></li>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-end">
          <div class="col-md-6  order-md-1">
            ...
            <h1 class="heading mb-3">Title 1</h1>
            <div class="sub-heading"><p class="mb-5">Mensaje <a href="#">Link</a></p>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <ul class="pb_contact_details_v1">
              ...
              <li>
                <span class="text-uppercase">Dirección</span>
                <p>Cochabamba-BO</p>
                <p>Av. (descripcion de la ubicacion)</p>
        ...
        <div class="row text-center">
          <div class="col">
            <ul class="list-inline">
              <li class="list-inline-item"><a href="#" class="p-2"><i class="fab fa-2x fa-facebook"></i></a></li>
              <li class="list-inline-item"><a href="#" class="p-2"><i class="fab fa-2x fa-instagram"></i></a></li>
              <li class="list-inline-item"><a href="#" class="p-2"><i class="fab fa-2x fa-twitter"></i></a></li>
              <li class="list-inline-item"><a href="#" class="p-2"><i class="fab fa-2x fa-linkedin"></i></a></li>
            </ul>
          </div>
        </div>
        <div class="row">
          <div class="col text-center">
            <p class="pb_font-14">&copy; 2020 <a href="#">Nombre(Empresa)</a>. All Rights Reserved. Designed by <a href="#">Link</a>Image</p>
          </div>
        </div>
      </div>
    </footer>
    ...
    <a href="https://api.whatsapp.com/send?phone=59177924850&text=Hola%20este%20es%20un%20mensaje%20de%20prueba" class="float-whatsapp" target="_blank">
	    <i class="fab fa-whatsapp my-float" title="Enviar Mensaje por Whatsapp"></i>
    </a>

    <a href="http://m.me/jorgemiguelcm" class="float-messenger" target="_blank">
      <i class="fab fa-facebook-messenger my-float" title="Enviar Mensaje por Messenger"></i>
    </a>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-V0PEYLRKVK"></script>
    <script>
